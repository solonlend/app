  ...
  return (
    <div className="text-primary-foreground w-full">
      ...
      <p className="text-secondary-foreground mt-3 max-w-2xl text-sm font-light">
        ...
        reserves or carrying leveraged LP debt. All four accrue the same way, as shares × time held, so wash loops earn
        nothing and letting debt grow earns nothing. The indexer is open source — recompute the whole board yourself.
      </p>
